...
export class Init1786171885878 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "carts" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "user_id" uuid, "country" character varying(2) NOT NULL DEFAULT 'US', "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_b5f695a59f5ebb50af3c8160816" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "orders" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "user_id" uuid NOT NULL, "customer_email" character varying, "status" character varying NOT NULL DEFAULT 'pending', "currency" character varying(3) NOT NULL, "subtotal_minor" integer NOT NULL, "shipping_minor" integer NOT NULL DEFAULT '0', "tax_minor" integer NOT NULL DEFAULT '0', "total_minor" integer NOT NULL, "refunded_minor" integer NOT NULL DEFAULT '0', "shipping_address" jsonb NOT NULL, "stripe_payment_intent_id" character varying, "tax_calculation_id" character varying, "carrier" character varying, "tracking_number" character varying, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_710e2d4957aa5878dfe94e4ac2f" PRIMARY KEY ("id"))`);
