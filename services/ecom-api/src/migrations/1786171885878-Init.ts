...
export class Init1786171885878 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "carts" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "user_id" uuid, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_b5f695a59f5ebb50af3c8160816" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "orders" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "reference" character varying, "user_id" uuid NOT NULL, "customer_email" character varying, "status" character varying NOT NULL DEFAULT 'pending', "currency" character varying(3) NOT NULL, "subtotal_minor" integer NOT NULL, "shipping_minor" integer NOT NULL DEFAULT '0', "tax_minor" integer NOT NULL DEFAULT '0', "total_minor" integer NOT NULL, "refunded_minor" integer NOT NULL DEFAULT '0', "shipping_address" jsonb NOT NULL, "payment_ref" character varying, "carrier" character varying, "tracking_number" character varying, "cancel_reason" text, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_710e2d4957aa5878dfe94e4ac2f" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_orders_reference" ON "orders" ("reference") `);
        ...
        await queryRunner.query(`CREATE TABLE "products" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "description" text, "image_url" character varying, "category" character varying, "stock" integer NOT NULL DEFAULT '0', "price_minor" integer NOT NULL DEFAULT '0', "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_0806c755e0aca124e67c0cf6d7d" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "shipping_rates" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "amount_minor" integer NOT NULL DEFAULT '0', CONSTRAINT "PK_c97b830633433697b24df68885a" PRIMARY KEY ("id"))`);
